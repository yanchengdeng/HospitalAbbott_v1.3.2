 ...
 */
public class TestBloodDeviceApiPresenter extends BasePresenter<TestBloodViewApiController> {
                ...
                try
                {
                    ...
                    if (length > 0) {
                        ...
                        ThreadHandler.postUiThread(new Runnable() {
                           ...
                           /* if (isSecondCode) {
                                Log.e("准备开始第二次写入", "======" + isSecondCode);
                                viewModel.log("准备开始第二次写入");
                                toWriteStringData(recv);
                            }*/
