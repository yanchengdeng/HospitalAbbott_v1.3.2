package com.comvee.hospitalabbott.receiver;
...
//            Toast.makeText(context, sb.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void toUpdateData() {
        Observable.timer(6, TimeUnit.SECONDS)//延迟六秒
                .throttleFirst(500, TimeUnit.MILLISECONDS) //500内只响应一次
                .compose(RxJavaUtil.<Long>applySchedulers())
                .subscribe(new Consumer<Long>() {
                    @Override
                    public void accept(@NonNull Long o) throws Exception {
                        // SubmitLocalUtils.postAllLocalTestInfo(null);
