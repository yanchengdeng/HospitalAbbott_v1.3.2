...
public class MaterialSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            textSize = ta.getDimension(R.styleable.MaterialSpinner_ms_tv_text_size, 17);
//            LogUtils.e(textSize + "");

            adapterTextColor = ta.getColor(R.styleable.MaterialSpinner_ms_adapter_text_color, defaultColor);
        ...
        setClickable(true);
        setPadding((int) getResources().getDimension(R.dimen.top_left), top, right, bottom);
...
//        setBackgroundColor(getResources().getColor(android.R.color.transparent));
        ...
        spinnerWindow = new SpinnerWindow(context, new AdapterView.OnItemClickListener() {
...
//                }
        ...
        spinnerWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            @Override
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (spinnerWindow != null) {
            bundle.putBoolean("is_popup_showing", spinnerWindow.isShowing());
            collapse();
        } else {
...
//        adapter = new MaterialSpinnerAdapter<>(getContext(), items).setTextColor(textColor);
    ...
    private void setAdapterInternal(@NonNull MaterialSpinnerBaseAdapter adapter) {
        spinnerWindow.setListAdapter(adapter);
...
//            spinnerWindow.setOverlapAnchor(false);
            spinnerWindow.showAsDropDown(this);
    ...
    public <T> void notifyDataSetChanged(@NonNull T... items) {
        setItems(Arrays.asList(items));
