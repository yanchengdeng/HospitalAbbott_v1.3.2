package com.comvee.hospitalabbott.widget.magicindicator.buildins;
...
import com.comvee.hospitalabbott.widget.magicindicator.NavigatorHelper;
import com.comvee.hospitalabbott.widget.magicindicator.ScrollState;
import com.comvee.hospitalabbott.widget.magicindicator.abs.IPagerNavigator;
...
import com.comvee.hospitalabbott.widget.magicindicator.buildins.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private boolean isTrisection; //根据屏幕大小，进行三等分，一屏幕最多显示三个item
            ...
            if (v instanceof View) {
                ...
                if (mAdjustMode) {
                    ...
                    if (isTrisection) {
                        ...
                        lp = new LinearLayout.LayoutParams((width / 3), LayoutParams.MATCH_PARENT);
                    } else {
    ...
    public boolean isTrisection() {
        return isTrisection;
    }

    public void setTrisection(boolean trisection) {
        isTrisection = trisection;
    }
}
