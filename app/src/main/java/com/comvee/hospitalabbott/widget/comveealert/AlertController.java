package com.comvee.hospitalabbott.widget.comveealert;
...
import com.comvee.hospitalabbott.widget.MyLRTextView;
...
public class AlertController {
	...
	private MyLRTextView mMessageView;
	...
	private void setupView() {
		...
		boolean hasContent = setupContent(contentPanel);
		...
		if (hasTitle && hasButtons) {
			if (mView != null) {
				contentPanel.setBackgroundResource(R.drawable.alert_bg_center);
				mWindow.findViewById(R.id.customPanel).setBackgroundResource(
						R.drawable.alert_bg_center);
			} else {
				contentPanel.setBackgroundResource(R.drawable.alert_bg_center);
			}
			...
			if (mView != null) {
				if (hasContent) {
					contentPanel.setBackgroundResource(R.drawable.alert_bg_top);
					mWindow.findViewById(R.id.customPanel)
							.setBackgroundResource(R.drawable.alert_bg_center);
				} else {
					mWindow.findViewById(R.id.customPanel)
							.setBackgroundResource(R.drawable.alert_bg_top);
				}
			} else {
				contentPanel.setBackgroundResource(R.drawable.alert_bg_top);
			}
			...
			if (mView != null) {
				contentPanel.setBackgroundResource(R.drawable.alert_bg_center);
				mWindow.findViewById(R.id.customPanel).setBackgroundResource(
						R.drawable.alert_bg_bottom);
			} else {
				contentPanel.setBackgroundResource(R.drawable.alert_bg_bottom);
			}
		} else if (!hasTitle && !hasButtons) {
			if (mView != null) {
				contentPanel.setBackgroundResource(R.drawable.alert_bg_top);
				...
				contentPanel.setBackgroundResource(R.drawable.alert_bg_fill);
			}
		}
	...
	private boolean setupTitle(LinearLayout topPanel) {
		...
		if (mCustomTitleView != null) {
			...
			if (hasTextTitle) {
				...
				// Hide the title template
				// View titleTemplate =
				// mWindow.findViewById(R.id.title_template);
				// titleTemplate.setVisibility(View.GONE);
				// mIconView.setVisibility(View.GONE);
				topPanel.setVisibility(View.GONE);
				hasTitle = false;
	...
	private boolean setupContent(LinearLayout contentPanel) {
		mScrollView = (ScrollView) mWindow.findViewById(R.id.scrollView);
		mScrollView.setFocusable(false);

		// Special case for users that only want to display a String
		mMessageView = (MyLRTextView) mWindow.findViewById(R.id.message);
		if (mMessageView == null) {
			return false;
		}
	...
	private boolean setupButtons() {
		...
		int whichButtons = 0;
		int numButtons = 0;
		boolean BL_BUTTON_POSITIVE = false;
		boolean BL_BUTTON_NEGATIVE = false;
		boolean BL_BUTTON_NEUTRAL = false;
		...
		// set ButtonBg
		View spacer_13 = mWindow.findViewById(R.id.spacer_13);
		View spacer_32 = mWindow.findViewById(R.id.spacer_32);
		if (numButtons < 2) {
			spacer_13.setVisibility(View.GONE);
			spacer_32.setVisibility(View.GONE);
		} else if (numButtons == 2) {
			if (BL_BUTTON_NEGATIVE && BL_BUTTON_NEUTRAL) {
				spacer_13.setVisibility(View.GONE);
				spacer_32.setVisibility(View.VISIBLE);
			} else {
				spacer_13.setVisibility(View.VISIBLE);
				spacer_32.setVisibility(View.GONE);
			}
		} else {
			spacer_13.setVisibility(View.VISIBLE);
		...
		if (BL_BUTTON_POSITIVE) {
			switch (numButtons) {
			case 1:
				mButtonPositive
						.setBackgroundResource(R.drawable.alert_btn_bg_bottom);
				break;

			default:
				mButtonPositive
						.setBackgroundResource(R.drawable.alert_btn_bg_left);
				break;
			}
		}

		if (BL_BUTTON_NEUTRAL) {
			switch (numButtons) {
			case 1:
				mButtonNeutral
						.setBackgroundResource(R.drawable.alert_btn_bg_bottom);
			...
			case 2:
				if (BL_BUTTON_POSITIVE) {
					mButtonNeutral
							.setBackgroundResource(R.drawable.alert_btn_bg_right);
				} else {
					mButtonNeutral
							.setBackgroundResource(R.drawable.alert_btn_bg_left);
				}
			...
			default:
				mButtonNeutral
						.setBackgroundResource(R.drawable.alert_btn_bg_center);
				break;
			}
		}

		if (BL_BUTTON_NEGATIVE) {
			switch (numButtons) {
			case 1:
				mButtonNegative
						.setBackgroundResource(R.drawable.alert_btn_bg_bottom);
					...
					adapter = new CursorAdapter(mContext, mCursor, false) {
						...
						public View newView(Context context, Cursor cursor,
							...
							return mInflater.inflate(
									R.layout.select_dialog_multichoice, parent,
									false);
						}
