...
public final class AppUtils {
    ...
    public static int APP_VERSION_CODE = AppUtils.getVerCode(XTYApplication.getInstance());
    ...
    public static void installApk(Context context, File file) {
        /**
         * 静默安装 1.需要root 2.无障碍安装
         */
//        new SilentInstall().install("/storage/emulated/0/sougou.apk");
